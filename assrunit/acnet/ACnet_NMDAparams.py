...
netParams.popParams['PYR'] = {'cellModel': 'PYR_Hay', 'cellType': 'PYR', 'numCells': 256,
                              'color': 'blue'}  # add dict with params for this pop  (196=16*16)
netParams.popParams['BASK'] = {'cellModel': 'BASK_Vierling', 'cellType': 'BASK', 'numCells': 64,
                               'color': 'red'}  # add dict with params for this pop  (64=8*8)
...
netParams.stimTargetParams['drive->BASK'] = {'source': 'drive', 'conds': {'popLabel': 'BASK', 'cellList': cellList},
                                             'weight': 0.1}
...
netParams.connParams['PYR->PYR'] = {
    ...
    # weight for NMDA synapse 50% of AMPA synapse (matches ~45% as in other model (Spencer,2009) and experiments (Myme et al.,2003))
    'threshold': 10,
    'synMech': ['AMPA', 'NMDA']}
...
netParams.connParams['PYR->BASK'] = {
    ...
    # weight for NMDA synapse 10% of AMPA synapse (matches 10% as in other model (Spencer,2009) and experiments (Munoz et al., 1999;Gonzalez-Burgos et al., 2005))
    'threshold': 10,
